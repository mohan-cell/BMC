...
oEpgChannelList = getEl('epg_nav_list'), oEpgOverview = getEl('epg_overview_table'),
 oCheckboxEpgSetting = getEl('enable_epg_setting'), oBufferSetting = getEl('buffer_setting'),
...
function downloadPlaylistAjax( sUrl, sCallback ) {
	...
	if( sUrl === "demo-pl.html" && typeof(sDemoPlaylist) !== 'undefined' ) {
...

{
        ...
        const iframeDoc = hlsFrame.contentDocument || hlsFrame.contentWindow.document;

iframeDoc.write('<video id="player" width="1920" height="1080" controls></video>');
